    ...
    >
      ...
      <div className="relative bg-white rounded-2xl shadow-[0_24px_80px_rgba(0,0,0,0.28)] w-full max-w-md overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="px-8 py-7 space-y-4">
          ...
          <div>
            <label className="block font-syne text-[12px] font-semibold text-text-muted mb-1.5">Adresse email</label>
            <input
              type="email"
              value={email}
          ...
          <div>
            <label className="block font-syne text-[12px] font-semibold text-text-muted mb-1.5">Mot de passe</label>
            <input
              type="password"
              value={password}
          ...
          <label className="flex items-start gap-3 cursor-pointer">
            <div className="relative mt-0.5">
              <input
                ...
                className="sr-only"
              />
              <div className={`w-4 h-4 rounded border-2 flex items-center justify-center transition-all duration-150 ${agreed ? 'bg-accent border-accent' : 'border-border bg-background'}`}>
                {agreed && (
            ...
            <span className="font-syne text-[12px] text-text-muted leading-relaxed">
              J&apos;accepte les{' '}
              <span className="text-accent font-semibold">conditions d&apos;utilisation</span>
              {' '}et la{' '}
              <span className="text-accent font-semibold">politique de confidentialité</span>
            </span>
          </label>
